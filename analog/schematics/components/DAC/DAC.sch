...
W=min_width
L=length}
C {ipin.sym} -100 180 0 0 {name=p17 lab=B5_n
W=min_width
L=length}
C {ipin.sym} -240 180 0 0 {name=p18 lab=B6_n
W=min_width
L=length}
C {ipin.sym} -380 180 0 0 {name=p19 lab=B7_n
W=min_width
L=length}
...
L=length}
C {devices/opin.sym} -550 50 2 0 {name=p20 lab=I_main
L=length}
