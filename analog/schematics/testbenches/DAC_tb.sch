...
S {}
E {}
B 2 -720 -620 90 -210 {flags=graph
y1=0.001943804
y2=0.014030949
ypos1=0
ypos2=2
...
node=v_dac_out_p
hilight_wave=-1}
N 900 -10 900 30 {lab=GND}
N 900 -10 940 -10 {lab=GND}
N 1070 30 1070 50 {lab=GND}
N 1210 -60 1270 -60 {lab=v_dac_out_p}
N 1070 -220 1070 -150 {lab=#net1}
N 1070 -220 1200 -220 {lab=#net1}
N 940 -280 940 -110 {lab=I_out_p}
N 1260 -280 1260 -60 {lab=v_dac_out_p}
N 940 -280 1070 -280 {lab=I_out_p}
N 1130 -280 1260 -280 {lab=v_dac_out_p}
N 900 470 900 510 {lab=GND}
N 900 470 940 470 {lab=GND}
N 1070 510 1070 530 {lab=GND}
N 1070 260 1070 330 {lab=#net2}
N 1070 260 1200 260 {lab=#net2}
N 940 200 940 370 {lab=I_out_n}
N 1260 200 1260 420 {lab=v_dac_out_n}
N 940 200 1070 200 {lab=I_out_n}
N 1130 200 1260 200 {lab=v_dac_out_n}
N 1210 420 1270 420 {lab=v_dac_out_n}
...
C {devices/launcher.sym} 490 -580 0 0 {name=h5
descr="load waves" 
...
spice_ignore=false}
C {devices/lab_pin.sym} 1270 -60 0 1 {name=p45 lab=v_dac_out_p
spice_ignore=false}
...
device=resistor
m=1}
C {devices/gnd.sym} 900 30 0 0 {name=l3 lab=GND
spice_ignore=false}
C {devices/gnd.sym} 1260 0 0 0 {name=l5 lab=GND
spice_ignore=false}
C {OpAmps/template/OpAmp.sym} 1090 420 0 0 {name=x3
spice_ignore=false}
C {devices/lab_pin.sym} 940 370 2 1 {name=p1 lab=I_out_n
spice_ignore=false}
C {devices/gnd.sym} 1070 530 0 0 {name=l23 lab=GND
spice_ignore=false}
C {devices/vsource.sym} 1010 580 0 0 {name=V23 value=0.9 savecurrent=false
spice_ignore=false}
C {devices/gnd.sym} 1010 610 0 0 {name=l24 lab=GND
spice_ignore=false}
C {devices/vsource.sym} 1200 290 0 0 {name=V24 value=1.8 savecurrent=false
spice_ignore=false}
C {devices/res.sym} 1100 200 1 0 {name=R6
value=1k
footprint=1206
device=resistor
m=1
spice_ignore=false}
C {devices/gnd.sym} 1200 320 0 0 {name=l30 lab=GND
spice_ignore=false}
C {devices/lab_pin.sym} 1270 420 0 1 {name=p2 lab=v_dac_out_n
spice_ignore=false}
C {devices/gnd.sym} 900 510 0 0 {name=l31 lab=GND
spice_ignore=false}
C {devices/res.sym} 1260 450 2 0 {name=R3
value=1k
footprint=1206
device=resistor
m=1
spice_ignore=false}
C {devices/gnd.sym} 1260 480 0 0 {name=l6 lab=GND
spice_ignore=false}
