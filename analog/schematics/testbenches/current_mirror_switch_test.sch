...
N 0 270 0 360 {
lab=B2}
N 40 270 70 270 {lab=B2}
N 60 240 60 270 {lab=B2}
N 60 210 60 240 {lab=B2}
...
N 230 260 230 350 {
lab=B1_bar}
N 270 260 300 260 {lab=B1_bar}
N 290 230 290 260 {lab=B1_bar}
N 290 200 290 230 {lab=B1_bar}
N 300 290 300 330 {lab=I_out_p}
N 340 260 340 350 {lab=B1_bar}
N 170 200 290 200 {lab=B1_bar}
N 170 160 170 200 {lab=B1_bar}
N 40 320 270 320 {lab=I_out_p}
N 70 330 300 330 {lab=I_out_p}
N 270 290 270 320 {lab=I_out_p}
N 290 -30 290 10 {
lab=#net7}
N 290 40 310 40 {lab=#net7}
N 310 10 310 40 {lab=#net7}
N 290 10 310 10 {lab=#net7}
...
N 440 260 440 350 {
lab=B0}
N 480 260 510 260 {lab=B0}
N 500 230 500 260 {lab=B0}
N 510 290 510 330 {lab=I_out_p}
N 550 260 550 350 {lab=B0}
N 480 290 480 320 {lab=I_out_p}
N 270 320 480 320 {lab=I_out_p}
N 300 330 510 330 {lab=I_out_p}
N 500 160 500 230 {lab=B0}
N 290 160 500 160 {lab=B0}
N 70 300 70 300 {lab=I_out_p}
N 110 270 110 270 {lab=B2}
N 70 300 70 300 {lab=I_out_p}
N 110 270 110 270 {lab=B2}
N 270 290 270 290 {lab=I_out_p}
N 230 260 230 260 {lab=B1_bar}
N 270 230 270 230 {lab=B1_bar}
N 270 260 270 260 {lab=B1_bar}
N 70 300 70 300 {lab=I_out_p}
N 110 270 110 270 {lab=B2}
N 270 290 270 290 {lab=I_out_p}
N 230 260 230 260 {lab=B1_bar}
N 270 230 270 230 {lab=B1_bar}
N 270 260 270 260 {lab=B1_bar}
N 300 290 300 290 {lab=I_out_p}
N 340 260 340 260 {lab=B1_bar}
N 300 230 300 230 {lab=B1_bar}
N 300 260 300 260 {lab=B1_bar}
N 70 300 70 300 {lab=I_out_p}
N 110 270 110 270 {lab=B2}
N 270 290 270 290 {lab=I_out_p}
N 230 260 230 260 {lab=B1_bar}
...
N 300 230 300 230 {lab=B1_bar}
N 300 260 300 260 {lab=B1_bar}
N 480 290 480 290 {lab=I_out_p}
N 440 260 440 260 {lab=B0}
N 480 230 480 230 {lab=B0}
N 480 260 480 260 {lab=B0}
N 70 300 70 300 {lab=I_out_p}
N 110 270 110 270 {lab=B2}
N 270 290 270 290 {lab=I_out_p}
N 230 260 230 260 {lab=B1_bar}
...
N 480 230 480 230 {lab=B0}
N 480 260 480 260 {lab=B0}
N 510 290 510 290 {lab=I_out_p}
N 550 260 550 260 {lab=B0}
N 510 230 510 230 {lab=B0}
N 510 260 510 260 {lab=B0}
...
C {devices/code_shown.sym} 120 670 0 0 {name=s1 only_toplevel=false value=".tran 1n 8u"}
...
C {devices/lab_pin.sym} 240 490 0 1 {name=p14 lab=I_out_p}
C {devices/lab_pin.sym} 350 490 0 1 {name=p15 lab=I_out_n}
C {devices/capa.sym} 350 520 0 0 {name=C2
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 240 550 0 0 {name=l4 lab=GND}
C {devices/gnd.sym} 350 550 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} -70 170 0 1 {name=p24 lab=I_main}
C {devices/capa.sym} 240 520 0 0 {name=C3
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
