...
spice_ignore=false}
C {devices/lab_pin.sym} 1050 -190 0 1 {name=p45 lab=v_dac_out
spice_ignore=false}
...
C {devices/gnd.sym} 290 -190 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} 290 -220 0 0 {name=V33 value=0 savecurrent=false}
