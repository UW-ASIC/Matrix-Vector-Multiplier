...
C {code_shown.sym} 250 50 0 0 {name=SPICE only_toplevel=false value=".temp 75
.noise v(Vout) I0 dec 10 1k 144Meg
.save all"}
C {isource.sym} -160 120 2 0 {name=I0 value="AC 0 DC 0"}
