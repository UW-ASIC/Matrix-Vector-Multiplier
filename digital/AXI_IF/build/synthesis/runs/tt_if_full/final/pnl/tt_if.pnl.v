module tt_if (i_clk,
 ...
 sky130_fd_sc_hd__dfrtp_1 _19_ (.CLK(clknet_1_1__leaf_i_clk),
    ...
    .VPWR(VDD),
    .Q(net3));
 sky130_fd_sc_hd__conb_1 tt_if_8 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net8));
 sky130_fd_sc_hd__conb_1 tt_if_9 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net9));
 sky130_fd_sc_hd__conb_1 tt_if_10 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net10));
 sky130_fd_sc_hd__conb_1 tt_if_11 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net11));
 sky130_fd_sc_hd__conb_1 tt_if_12 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net12));
 sky130_fd_sc_hd__conb_1 tt_if_13 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net13));
 sky130_fd_sc_hd__conb_1 tt_if_14 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net14));
 sky130_fd_sc_hd__conb_1 tt_if_15 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net15));
 sky130_fd_sc_hd__conb_1 tt_if_16 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net16));
 sky130_fd_sc_hd__conb_1 tt_if_17 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net17));
 sky130_fd_sc_hd__conb_1 tt_if_18 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net18));
 sky130_fd_sc_hd__conb_1 tt_if_19 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net19));
 sky130_fd_sc_hd__conb_1 tt_if_20 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_if_21 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_if_22 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_if_23 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_if_24 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_if_25 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_if_26 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net26));
 ...
 sky130_fd_sc_hd__buf_2 output6 (.A(net6),
    ...
    .VPWR(VDD),
    .X(uo_out[3]));
 sky130_fd_sc_hd__conb_1 tt_if_7 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .LO(net7));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(net6),
    ...
    .VPWR(VDD),
    .X(net31));
 sky130_ef_sc_hd__decap_12 FILLER_0_12 (.VPWR(VDD),
    .VGND(VSS),
    .VPB(VDD),
    .VNB(VSS));
 sky130_fd_sc_hd__decap_4 FILLER_0_24 (.VGND(VSS),
    ...
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_3 FILLER_0_49 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_8 FILLER_1_6 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_6 FILLER_1_42 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_1_48 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_ef_sc_hd__decap_12 FILLER_2_6 (.VPWR(VDD),
    .VGND(VSS),
    .VPB(VDD),
    .VNB(VSS));
 sky130_fd_sc_hd__decap_3 FILLER_2_25 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_8 FILLER_3_3 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_2 FILLER_3_11 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_ef_sc_hd__decap_12 FILLER_3_19 (.VPWR(VDD),
    .VGND(VSS),
    .VPB(VDD),
    .VNB(VSS));
 sky130_fd_sc_hd__decap_4 FILLER_3_31 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_3_35 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_4_6 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_4_24 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_3 FILLER_5_14 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_2 FILLER_5_37 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_8 FILLER_6_3 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_6_11 (.VGND(VSS),
    ...
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_6_27 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_6_29 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_2 FILLER_6_50 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_7_12 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_7_16 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_7_22 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__fill_1 FILLER_8_9 (.VGND(VSS),
    ...
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_8_13 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
 sky130_fd_sc_hd__decap_4 FILLER_8_20 (.VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD));
