module tt_if (i_clk,
 ...
 sky130_fd_sc_hd__and2_1 _15_ (.A(_04_),
    ...
    .VPWR(VDD),
    .X(_03_));
 sky130_fd_sc_hd__dfrtp_1 _16_ (.CLK(i_clk),
    .D(_00_),
    .RESET_B(net2),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(net4));
 sky130_fd_sc_hd__dfrtp_1 _17_ (.CLK(i_clk),
    .D(_01_),
    .RESET_B(net2),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(net5));
 sky130_fd_sc_hd__dfrtp_1 _18_ (.CLK(i_clk),
    .D(_02_),
    .RESET_B(net2),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_1 _19_ (.CLK(i_clk),
    .D(_03_),
    .RESET_B(net2),
    .VGND(VSS),
    .VNB(VSS),
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_8_22 (.VGND(VSS),
    .VPWR(VDD));
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(i_ena),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .X(net1));
 sky130_fd_sc_hd__dlymetal6s2s_1 input2 (.A(i_rst_n),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
