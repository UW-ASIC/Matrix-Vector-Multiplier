module tt_if (i_clk,
 ...
 sky130_fd_sc_hd__nand2_1 _08_ (.A(uo_out[0]),
    .B(i_ena),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .Y(_04_));
 sky130_fd_sc_hd__xnor2_1 _09_ (.A(uo_out[1]),
    .B(_04_),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .Y(_00_));
 sky130_fd_sc_hd__and4_1 _10_ (.A(uo_out[0]),
    .B(uo_out[1]),
    .C(uo_out[2]),
    .D(i_ena),
    .VGND(VSS),
    ...
    .VPWR(VDD),
    .X(_05_));
 sky130_fd_sc_hd__a31o_1 _11_ (.A1(uo_out[0]),
    .A2(uo_out[1]),
    .A3(i_ena),
    .B1(uo_out[2]),
    .VGND(VSS),
 ...
 sky130_fd_sc_hd__and2b_1 _12_ (.A_N(_05_),
    ...
    .VPWR(VDD),
    .X(_01_));
 sky130_fd_sc_hd__xor2_1 _13_ (.A(uo_out[3]),
    .B(_05_),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
    .VPWR(VDD),
    .X(_02_));
 sky130_fd_sc_hd__or2_1 _14_ (.A(uo_out[0]),
    .B(i_ena),
    .VGND(VSS),
    .VNB(VSS),
    .VPB(VDD),
 ...
 sky130_fd_sc_hd__and2_1 _15_ (.A(_04_),
    ...
    .VPWR(VDD),
    .X(_03_));
 sky130_fd_sc_hd__dfrtp_4 _16_ (.CLK(i_clk),
    .D(_00_),
    .RESET_B(i_rst_n),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_4 _17_ (.CLK(i_clk),
    .D(_01_),
    .RESET_B(i_rst_n),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_4 _18_ (.CLK(i_clk),
    .D(_02_),
    .RESET_B(i_rst_n),
    .VGND(VSS),
    .VNB(VSS),
    ...
    .VPWR(VDD),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_4 _19_ (.CLK(i_clk),
    .D(_03_),
    .RESET_B(i_rst_n),
    .VGND(VSS),
    .VNB(VSS),
